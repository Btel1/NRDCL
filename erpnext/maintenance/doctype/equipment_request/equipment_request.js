...
if (frm.doc.docstatus == 1 && frm.doc.percent_completed < 100 && (frm.doc.approval_status == 'Available' || frm.doc.approval_status == 'Partially Available')) {
...
/*cur_frm.cscript.custom_refresh = function(doc) {
    cur_frm.set_df_property("approval_status", "read_only", doc.ehf !== "")
}*/
